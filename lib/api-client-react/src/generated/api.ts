...
export const createEvent = async (
  ...
  formData.append(`title`, createEventRequest.title);
  formData.append(`description`, createEventRequest.description);
  formData.append(`category`, createEventRequest.category);
  formData.append(`venue`, createEventRequest.venue);
  formData.append(`eventDate`, createEventRequest.eventDate);
  formData.append(
    `registrationDeadline`,
    createEventRequest.registrationDeadline,
  );
  if (
    createEventRequest.maxParticipants !== undefined &&
    createEventRequest.maxParticipants !== null
  ) {
    formData.append(
      `maxParticipants`,
      createEventRequest.maxParticipants.toString(),
    );
  }
  if (
    createEventRequest.thumbnail !== undefined &&
    createEventRequest.thumbnail !== null
  ) {
    formData.append(`thumbnail`, createEventRequest.thumbnail);
  }
  if (
    createEventRequest.parentEventId !== undefined &&
    createEventRequest.parentEventId !== null
  ) {
    formData.append(
      `parentEventId`,
      createEventRequest.parentEventId.toString(),
    );
  }
  if (
    createEventRequest.previousEventId !== undefined &&
    createEventRequest.previousEventId !== null
  ) {
    formData.append(
      `previousEventId`,
      createEventRequest.previousEventId.toString(),
    );
  }
...
export const addEventPhoto = async (
  ...
  const formData = new FormData();
  addPhotoRequest.photos.forEach((value) => formData.append(`photos`, value));
  if (
    addPhotoRequest.caption !== undefined &&
    addPhotoRequest.caption !== null
  ) {
    formData.append(`caption`, addPhotoRequest.caption);
  }
